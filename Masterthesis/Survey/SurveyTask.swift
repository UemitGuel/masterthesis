...
public var SurveyTask: ORKOrderedTask {
    ...
    let whichUniChoices = [
        ORKTextChoice(text: "Ingenieurwissenschaften", value: "Ingenieurwissenschaften" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Naturwissenschaften", value: "Naturwissenschaften" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Wirtschaftswissenschaften", value: "Wirtschaftswissenschaften" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Medizin", value: "Medizin" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Jura", value: "Jura" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Sozialwissenschaften", value: "Sozialwissenschaften" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Informatik", value: "Informatik" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Lehramt", value: "Lehramt" as NSCoding & NSCopying & NSObjectProtocol),
        ORKTextChoice(text: "Sonstiges", value: "Sonstiges" as NSCoding & NSCopying & NSObjectProtocol)
    ]
    ...
    let whichGenderChoices = [
        ...
        ORKTextChoice(text: "divers", value: "divers" as NSCoding & NSCopying & NSObjectProtocol)
    ]
